...
class DatabaseHelper {
  ...
  /// Returns all orders (for admin), optionally filtered by [from] and [to]
  /// date range (inclusive). Joins users table for customer info.
  ...
  /// Returns order detail including its items (with product / variant info).
